...
export default {
  ...
  methods: {
    getList(obj) {
      ...
      getHandleType(this.listQuery).then(response => {
    ...
    createData() {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          createHandleType(this.temp).then(response => {
            this.restTemp()
            this.restData()
            this.getList()
            this.$message({
    ...
    updateData() {
      this.$refs['dataForm'].validate(valid => {
        if (valid) {
          ...
          updateHandleType(tempData).then(() => {
            this.restData()
            this.getList()
            this.$message({
              title: 'Success',
    ...
    confirmDjalog() {
      ...
      deleteHandleType(while_id).then(() => {
        this.confirmDelete = false
        this.getList()
        this.$message({
          title: 'Success',
