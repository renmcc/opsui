...
export function getServersList(listQuery) {
  ...
  let urlStr = `/api/assents/?search=${listQuery.search}&region=${listQuery.region}&project=${listQuery.project}&area=${listQuery.area}&update_time_after=${after_date}&update_time_before=${before_date}&ordering=${listQuery.order}${listQuery.prop}&page=${listQuery.page}&page_size=${listQuery.pageSize}`
